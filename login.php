...
if (!empty($_POST)) {
    ...
    if (
        ...
        //bindValue protection , la valeur reçoit comme paramètre , obligation de traiter cela en chaine de caractère.
        ...
        // session_start();------------------commenté pour raison de video 14 (cf profil.php) ---------------
